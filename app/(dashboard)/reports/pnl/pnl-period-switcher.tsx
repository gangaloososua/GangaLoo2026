...
// Reports - P&L period switcher.
// Updates the ?period= (and ?start=/?end= for custom) query params; the server
// page re-renders with new data. Mirrors the dashboard switcher, plus a Custom
// range that reveals two native date inputs.

import { useRouter, useSearchParams } from 'next/navigation'
import { useState } from 'react'
import { Button } from '@/components/ui/button'

const BASE = '/reports/pnl'
...
export function PnlPeriodSwitcher({
  current,
  start,
  end,
}: {
